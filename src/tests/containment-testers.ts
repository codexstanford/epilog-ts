...
function runCQContainmentTesterTests() {
    ...
    runTest("CQContainment-reflexive-true", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q(X,Y) :- a(X,Z) & b(Y) & c(hosp2)"))
    ...
    runTest("CQContainment-ground-true", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q() :- person.name(bob, \"Robert\")"))
        let q2 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q() :- person.name(bob, \"Robert\") & person.spouse(bob, susan)"))
    ...
    runTest("CQContainment-simple-1-true", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q(X,Y) :- a(X,Z) & b(Y) & c(hosp2)"))
        let q2 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q(X,Y) :- a(X,Z) & b(Y)"))
    ...
    runTest("CQContainment-simple-2-true", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q(X,Y) :- b1(X,Y)"))
        let q2 : CQ = new ConjunctiveQuery(new Predicate("q"), StrToTS.parseRule("q(X,Y) :- b1(X,Y) &  b1(X,X)"))
    ...
    runTest("CQContainment-simple-3-true", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("p"), StrToTS.parseRule("p(X,Y) :- r(X,Y) & r(Y,X) & b1(X) & b3()"))
        let q2 : CQ = new ConjunctiveQuery(new Predicate("p"), StrToTS.parseRule("p(X,Y) :- r(X,Y) & r(Y,Z)"))
    ...
    runTest("CQContainment-simple-4a-false", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("p"), StrToTS.parseRule("p(X,Y,Z) :- r1(X,Y,Z) & q(Z,Z)"))
        let q2 : CQ = new ConjunctiveQuery(new Predicate("p"), StrToTS.parseRule("p(X,Y,Z) :- r1(X,Y,Z) & q(Z,Y)"))
    ...
    runTest("CQContainment-simple-5-true", () => {
        ...
        let q1 : CQ = new ConjunctiveQuery(new Predicate("p"), StrToTS.parseRule("p(X,Y,Z) :- r1(X,Y,Z) & q(Z,Z)"))
        let q2 : CQ = new ConjunctiveQuery(new Predicate("p"), StrToTS.parseRule("p(X,Y,Z) :- r1(X,Y,Z) & q(Z,W)"))
