...
function runGeneralTests() : void {
    printTestingMessage_Start("General Utils");

    runIsInNNFTests();
}

function runIsInNNFTests() : void {
...
function runStandardizeVarNamesTests() : void {
    ...
    runTest("Standardize-Var-Names-free-var-failure", () => {
        ...
        let result : Formula = standardizeVarNames(initialFormula);
    ...
    runTest("Standardize-Var-Names-Literal-without-var-success", () => {
        let initialFormula : Formula = p_c;
        let result : Formula = standardizeVarNames(bindFreeVars(initialFormula));
    ...
    runTest("Standardize-Var-Names-Conjunction-top-level-success", () => {
        let initialFormula : Formula = new Conjunction([np_x, p_x, s_xyz]);
        let result : Formula = standardizeVarNames(bindFreeVars(initialFormula));
    ...
    runTest("Standardize-Var-Names-Disjunction-top-level-success", () => {
        let initialFormula : Formula = new Disjunction([np_x, p_x, s_xyz]);
        let result : Formula = standardizeVarNames(bindFreeVars(initialFormula));
    ...
    runTest("Standardize-Var-Names-Implication-top-level-success", () => {
        let initialFormula : Formula = new Implication(np_x, s_xyz);
        let result : Formula = standardizeVarNames(bindFreeVars(initialFormula));
    ...
    runTest("Standardize-Var-Names-Biconditional-top-level-success", () => {
        let initialFormula : Formula = new Biconditional(np_x, s_xyz);
        let result : Formula = standardizeVarNames(bindFreeVars(initialFormula));
