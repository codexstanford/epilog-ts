...
function runCNFTests() : void {
    ...
    runTest("toCNF-non-QF formula-failure", () => {
        let initialFormula : Formula = f1;
        let result : Formula = toCNF(initialFormula);

        return result.toString() === ERROR_CONJUNCTION.toString();
    },{});

    runTest("toCNF-non-NNF formula-failure", () => {
        let initialFormula : Formula = impl1_unsafe;
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-single negative unit clause-success", () => {
        let initialFormula : Formula = p_y;
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-single negated unit clause-success", () => {
        let initialFormula : Formula = np_x;
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat empty Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat empty Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([new Conjunction([])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat positive unit Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([p_x]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat negative unit Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([p_y]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat negated unit Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([np_x]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat wide Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([p_x, p_y, np_x]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat narrow Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([new Conjunction([new Conjunction([p_x])])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat wide Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([new Conjunction([p_x, q_x]), new Conjunction([p_y, q_y]), new Conjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-variable depth Conjunction-success", () => {
        let initialFormula : Formula = new Conjunction([p_x, new Conjunction([new Conjunction([p_y, q_y]), q_x]), new Conjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat empty Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat empty Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([new Disjunction([])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat positive unit Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([p_x]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat negative unit Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([p_y]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat negated unit Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([np_x]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-flat wide Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([p_x, p_y, np_x]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat narrow Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([new Disjunction([new Disjunction([p_x])])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat wide Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([new Disjunction([p_x, q_x]), new Disjunction([p_y, q_y]), new Disjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-variable depth Disjunction-success", () => {
        let initialFormula : Formula = new Disjunction([p_x, new Disjunction([new Disjunction([p_y, q_y]), q_x]), new Disjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat Conjunction with Disjunction-success", () => {
        let initialFormula : Formula = new Conjunction([new Disjunction([p_x, q_x]), new Disjunction([p_y, q_y]), new Disjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-non-flat wide Disjunction with Conjunction-success", () => {
        let initialFormula : Formula = new Disjunction([new Conjunction([p_x, q_x]), new Conjunction([p_y, q_y]), new Conjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-variable depth Conjunction with Disjunction-success", () => {
        let initialFormula : Formula = new Conjunction([p_x, new Disjunction([new Disjunction([p_y, q_y]), q_x]), new Disjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-variable depth Disjunction with Conjunction-success", () => {
        let initialFormula : Formula = new Disjunction([p_x, new Conjunction([new Conjunction([p_y, q_y]), q_x]), new Conjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-variable depth Conjunction with both-success", () => {
        let initialFormula : Formula = new Conjunction([p_x, new Disjunction([new Disjunction([p_y, q_y]), q_x]), new Conjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-variable depth Disjunction with both-success", () => {
        let initialFormula : Formula = new Disjunction([p_x, new Disjunction([new Disjunction([p_y, q_y]), q_x]), new Conjunction([np_x, nq_x])]);
        let result : Formula = toCNF(initialFormula);
    ...
    let p_list : Literal[] = [ERROR_LITERAL];
    ...
    runTest("toCNF-Decision Procedures example 1.21-success", () => {
        let initialFormula : Formula = toNNF(new Implication(p_list[1], new Conjunction([p_list[2], p_list[3]])));
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-Decision Procedures example 1.29a-success", () => {
        let initialFormula : Formula = new Conjunction([p_list[2], p_list[3], p_list[4], p_list[5]]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF-CS257 Fall 2022 Lecture 1 example-success", () => {
        let initialFormula : Formula = new Disjunction([new Conjunction([p_list[4], new Conjunction([p_list[1], p_list[2]])]), new Conjunction([new Conjunction([p_list[1], p_list[2]]), new Negation(p_list[3])])]);
        let result : Formula = toCNF(initialFormula);
...
// These tests are disabled by default, as they only work properly when the checks in toCNF for QF and NNF formulae are disabled. 
function runToCNF_helperTests() : void {
    ...
    runTest("toCNF_helper-nonatomic negation-failure", () => {
        let initialFormula : Formula = new Negation(new Negation(p_x));
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-double negation-failure", () => {
        let initialFormula : Formula = new Negation(p_y);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-nonatomic negation as conjunct-failure", () => {
        let initialFormula : Formula = new Conjunction([new Negation(new Negation(p_x))]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-double negation as conjunct-failure", () => {
        let initialFormula : Formula = new Conjunction([new Negation(p_y)]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-nonatomic negation as disjunct-failure", () => {
        let initialFormula : Formula = new Disjunction([new Negation(new Negation(p_x))]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-double negation as disjunct-failure", () => {
        let initialFormula : Formula = new Disjunction([new Negation(p_y)]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-Implication-failure", () => {
        let initialFormula : Formula = new Implication(p_x, p_x);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-Implication as conjunct-failure", () => {
        let initialFormula : Formula = new Conjunction([new Implication(p_x, p_x)]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-Implication as disjunct-failure", () => {
        let initialFormula : Formula = new Disjunction([new Implication(p_x, p_x)]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-Biconditional-failure", () => {
        let initialFormula : Formula = new Biconditional(p_x, p_x);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-Biconditional as conjunct-failure", () => {
        let initialFormula : Formula = new Conjunction([new Biconditional(p_x, p_x)]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-Biconditional as disjunct-failure", () => {
        let initialFormula : Formula = new Disjunction([new Biconditional(p_x, p_x)]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-QuantifiedFormula-failure", () => {
        let initialFormula : Formula = bindFreeVars(new Implication(p_x, p_x));
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-QuantifiedFormula as conjunct-failure", () => {
        let initialFormula : Formula = new Conjunction([bindFreeVars(new Implication(p_x, p_x))]);
        let result : Formula = toCNF(initialFormula);
    ...
    runTest("toCNF_helper-QuantifiedFormula as disjunct-failure", () => {
        let initialFormula : Formula = new Disjunction([bindFreeVars(new Implication(p_x, p_x))]);
        let result : Formula = toCNF(initialFormula);
