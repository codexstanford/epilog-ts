...
function runDisjunctionTests() {
    ...
    runTest("Disjunction-unit-success", () => {
        ...
        let l1 = new Literal(atom1, false);
        let d1 = new Disjunction([l1]);
    ...
    runTest("Disjunction-many-1-success", () => {
        ...
        let l1 = new Literal(atom1, false);
        let l2 = new Literal(atom2, true);
        let d1 = new Disjunction([l1, l2]);
    ...
    runTest("Disjunction-many-2-success", () => {
        ...
        let l1 = new Literal(atom1, false);
        let l2 = new Literal(atom2, true);
        let d1 = new Disjunction([l1, l2, l1]);
...
function runConjunctionTests() {
    ...
    runTest("Conjunction-many-2-success", () => {
        ...
        let l1 = new Literal(atom1, false);
        let l2 = new Literal(atom2, true);
        let c1 = new Conjunction([l1, l2, l1]);
    ...
    runTest("Conjunction-complex-success", () => {
        ...
        let l1 = new Literal(atom1, false);
        let l2 = new Literal(atom2, true);
        let c1 = new Conjunction([new Literal(atom1, true), new Literal(atom2, false)]);
        let d = new Disjunction([l1, l2]);
        let c2 = new Conjunction([d, c1]);
...
function runNegationTests() {
    ...
    runTest("Negation-complex-success", () => {
        ...
        let d = new Disjunction([l1, l2]);
        let c2 = new Conjunction([d, c1]);
        let n1 = new Negation(c2);
        return n1.toString() === '¬((p() ∨ ~q()) ∧ (~p() ∧ q()))' &&
            n1.target === c2;
    }, {});
}
function runImplicationTests() {
    printTestingMessage_Start("Implication");
    runTest("Implication-simple-success", () => {
        let atom1 = new Atom(new Predicate("p"), []);
        let atom2 = new Atom(new Predicate("q"), []);
        let l1 = new Literal(atom1, false);
        let l2 = new Literal(atom2, false);
        let im1 = new Implication(l1, l2);
    ...
    runTest("Implication-complex-success", () => {
        ...
        let atom2 = new Atom(new Predicate("q"), []);
        let l2 = new Literal(atom2, true);
        let c1 = new Conjunction([l1, new Literal(atom2, false)]);
        let d = new Disjunction([new Literal(atom1, false), l2]);
        let c2 = new Conjunction([d, c1]);
        let im1 = new Implication(n1, c2);
        return im1.toString() === '(¬~p() ⇒ ((p() ∨ ~q()) ∧ (~p() ∧ q())))' &&
            im1.antecedent === n1 &&
            im1.consequent === c2;
    }, {});
}
function runBiconditionalTests() {
    ...
    runTest("Biconditional-complex-success", () => {
        ...
        let c2 = new Conjunction([d, c1]);
        let im1 = new Implication(n1, c2);
        let b1 = new Biconditional(im1, c2);
        return b1.toString() === '((¬~p() ⇒ ((p() ∨ ~q()) ∧ (~p() ∧ q()))) ⇔ ((p() ∨ ~q()) ∧ (~p() ∧ q())))' &&
            b1.antecedent === im1 &&
            b1.consequent === c2;
    }, {});
}
function runQuantifiedFormulaTests() {
    ...
    runTest("QuantifiedFormula-universal-simple-success", () => {
        ...
        let l2 = new Literal(atom2, false);
        let b1 = new Biconditional(l1, l2);
        let u1 = new QuantifiedFormula(Quantifier.Universal, new Variable("X"), b1);
    ...
    runTest("QuantifiedFormula-universal-simple-failure", () => {
        ...
        let l2 = new Literal(atom2, false);
        let b1 = new Biconditional(l1, l2);
        let u1 = new QuantifiedFormula(Quantifier.Universal, new Variable("_"), b1);
    ...
    runTest("QuantifiedFormula-universal-complex-success", () => {
        ...
        let im1 = new Implication(n1, c2);
        let b1 = new Biconditional(im1, c2);
        let u1 = new QuantifiedFormula(Quantifier.Universal, new Variable("Var23"), b1);
    ...
    runTest("QuantifiedFormula-existential-simple-success", () => {
        ...
        let l2 = new Literal(atom2, false);
        let b1 = new Biconditional(l1, l2);
        let u1 = new QuantifiedFormula(Quantifier.Existential, new Variable("X"), b1);
        return u1.toString() === '∃X.((p() ⇔ q()))' &&
            u1.formula === b1;
    }, {});
    runTest("QuantifiedFormula-existential-simple-failure", () => {
        ...
        let l2 = new Literal(atom2, false);
        let b1 = new Biconditional(l1, l2);
        let u1 = new QuantifiedFormula(Quantifier.Existential, new Variable("_"), b1);
        return u1.toString() === '∃_.((p() ⇔ q()))' &&
            u1.formula === b1;
    }, {});
    runTest("QuantifiedFormula-existential-complex-success", () => {
        ...
        let im1 = new Implication(n1, c2);
        let b1 = new Biconditional(im1, c2);
        let u1 = new QuantifiedFormula(Quantifier.Existential, new Variable("Var23"), b1);
        return u1.toString() === '∃Var23.(((¬~p() ⇒ ((p() ∨ ~q()) ∧ (~p() ∧ q()))) ⇔ ((p() ∨ ~q()) ∧ (~p() ∧ q()))))' &&
            u1.formula === b1;
    }, {});
}
function runClauseTests() {
